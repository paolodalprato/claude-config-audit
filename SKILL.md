...
and schemas, runtime metadata) is specific to each environment: the
report measures it in the opening footprint for proportion, but it is
not configurable and is never audited.
